 ...
 */
fun EpoxyFragment.simpleController(
 ...
 */
fun <S : MavericksState, A : MavericksViewModel<S>> EpoxyFragment.simpleController(
    viewModel: A,
 ...
 */
fun <A : MavericksViewModel<B>, B : MavericksState, C : MavericksViewModel<D>, D : MavericksState> EpoxyFragment.simpleController(
    viewModel1: A,
    viewModel2: C,
 ...
 * When models are built the current state of the viewmodels will be provided.
 */
fun <A : MavericksViewModel<B>, B : MavericksState, C : MavericksViewModel<D>, D : MavericksState, E : MavericksViewModel<F>, F : MavericksState> EpoxyFragment.simpleController(
    viewModel1: A,
    viewModel2: C,
    viewModel3: E,
